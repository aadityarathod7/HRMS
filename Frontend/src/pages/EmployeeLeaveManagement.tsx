...
const EmployeeLeaveManagement: React.FC = () => {
  ...
  const handleStatusChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    // useEffect triggers fetchLeaves with new status automatically
  };
      ...
      <div className={`flex flex-col flex-grow transition-all duration-300 ${isCollapsed ? "pl-20 pr-6" : "pl-72 pr-6"}`}>
        <div className="pt-28 px-5 pb-5 flex-grow">
          <div className="flex items-center justify-between mb-5">
            <div>
              <h1 className="text-2xl font-light text-gray-900">Leave Requests</h1>
              <p className="text-sm text-gray-400 mt-1">Approve or reject employee leave requests</p>
            </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="px-4 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider text-left">Manager</th>
              ...
              <tbody className="divide-y divide-gray-100">
                {loading ? (
                  ...
                  <tr><td colSpan={7} className="text-center py-8 text-gray-400 text-sm">No {selectedStatus.toLowerCase()} leave requests</td></tr>
                  ...
                  <tr key={`${leave.id}-${index}`} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-sm text-gray-600">
                      {typeof leave.reportingManagerId === "object"
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        {leave.leaveStatus === "PENDING" && canApprove && (
                          <>
